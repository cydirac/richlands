<?php
class ModelThmblogBlog extends Model {

	public function createtableBlogTables() {
		
		$checkBlogTable = "SHOW TABLES LIKE '".DB_PREFIX."thmblog' ";
		$queryBlog=$this->db->query($checkBlogTable);
		if($queryBlog->num_rows==0){
		    $createBlogTable = "
			CREATE TABLE " . DB_PREFIX . "thmblog (
		...
		$createBlogTable_rp = "
		CREATE TABLE " . DB_PREFIX . "thmblog_related_product (
		...
		$createBlogTable_ra = "
		CREATE TABLE " . DB_PREFIX . "thmblog_related_article (
		`blog_id` int(11) NOT NULL,
		...
		$checkBlogDespTable = "SHOW TABLES LIKE '".DB_PREFIX."thmblog_description' ";
		$queryBlogDesp=$this->db->query($checkBlogDespTable);
		if($queryBlogDesp->num_rows==0){
		    $createBlogDespTable = "
			CREATE TABLE " . DB_PREFIX . "thmblog_description (
			`blog_id` int(11) NOT NULL ,
		...
		$checkBlogCatTable = "SHOW TABLES LIKE '".DB_PREFIX."thmblog_to_category' ";
		$queryBlogCat=$this->db->query($checkBlogCatTable);
		if($queryBlogCat->num_rows==0){
		    $createBlogCatTable = "
			CREATE TABLE " . DB_PREFIX . "thmblog_to_category (
			`blog_id` int(11) NOT NULL ,
		...
		$checkBlogStoreTable = "SHOW TABLES LIKE '".DB_PREFIX."thmblog_to_store' ";
		$queryBlogStore=$this->db->query($checkBlogStoreTable);
		if($queryBlogStore->num_rows==0){
		    $createBlogStoreTable = "
			CREATE TABLE " . DB_PREFIX . "thmblog_to_store (
			`blog_id` int(11) NOT NULL ,
		...
		$checkCategoryTable = "SHOW TABLES LIKE '".DB_PREFIX."thmblogcategory' ";
		$queryCategory=$this->db->query($checkCategoryTable);
		if($queryCategory->num_rows==0){
		    $createCategoryTable = "
			CREATE TABLE " . DB_PREFIX . "thmblogcategory (
		...
		$checkCategoryDespTable = "SHOW TABLES LIKE '".DB_PREFIX."thmblogcategory_description' ";
		$queryCategoryDesp=$this->db->query($checkCategoryDespTable);
		if($queryCategoryDesp->num_rows==0){
		    $createCategoryDespTable = "
			CREATE TABLE " . DB_PREFIX . "thmblogcategory_description (
			`category_id` int(11) NOT NULL ,
			`language_id` int(11) unsigned NOT NULL,
		...
		$checkCategoryStoreTable = "SHOW TABLES LIKE '".DB_PREFIX."thmblogcategory_to_store' ";
		$queryCategoryStore=$this->db->query($checkCategoryStoreTable);
		if($queryCategoryStore->num_rows==0){
		    $createCategoryStoreTable = "
			CREATE TABLE " . DB_PREFIX . "thmblogcategory_to_store (
			`category_id` int(11) NOT NULL ,
			`store_id` int(11) NOT NULL,
	...
	public function createDefaultBlogLayout() {
		...
		$sql1 = "INSERT INTO `".DB_PREFIX."layout_route` (
				...
				VALUES (NULL , '".$id."', '0', 'thmblog/article');";
		...
		$sql2 = "INSERT INTO `".DB_PREFIX."layout_route` (
				...
				VALUES (NULL , '".$id."', '0', 'thmblog/article/tag');";
		...
		$sql3 = "INSERT INTO `".DB_PREFIX."layout_route` (
				...
				VALUES (NULL , '".$id."', '0', 'thmblog/article/view');";
		...
		$sql4 = "INSERT INTO `".DB_PREFIX."layout_route` (
				...
				VALUES (NULL , '".$id."', '0', 'thmblog/category');";
		...
		$sql5 = "INSERT INTO `".DB_PREFIX."layout_route` (
				...
				VALUES (NULL , '".$id."', '0', 'thmblog/search');";
