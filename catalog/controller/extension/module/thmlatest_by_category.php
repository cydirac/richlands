...
class ControllerExtensionModuleThmlatestbycategory  extends Controller {
	...
	public function index($setting) {
		...
		$results1 = $this->model_extension_module_thmlatest_by_category->getthmlatestCategoryProducts($data1);
		...
		$results2 = $this->model_extension_module_thmlatest_by_category->getthmlatestCategoryProducts($data2);
		...
		$results3 = $this->model_extension_module_thmlatest_by_category->getthmlatestCategoryProducts($data3);
		...
		$results4 = $this->model_extension_module_thmlatest_by_category->getthmlatestCategoryProducts($data4);
		...
		// $results5 = $this->model_extension_module_thmlatest_by_category->getthmlatestCategoryProducts($data5);
		...
		return $this->load->view('extension/module/thmlatest_by_category', $data);
