...
<link href="catalog/view/theme/<?php echo $thm_theme ?>/stylesheet/flexslider.css" rel="stylesheet">
<script type="text/javascript" src="catalog/view/theme/<?php echo $thm_theme ?>/js/jquery.flexslider.js"></script> 
<script type="text/javascript" src="catalog/view/theme/<?php echo $thm_theme ?>/js/cloudzoom.js"></script>
<script src="catalog/view/javascript/jquery/owl-carousel/owl.carousel.min.js" type="text/javascript"></script>
<div class="thm-quickview">
...
<!--               <div class="form-group">
          ...
          <li><a class="link-wishlist" title="<?php echo $button_wishlist; ?>" onclick="tm_qv_wishlist.add('<?php echo $product_id; ?>');">
          <span><?php echo $button_wishlist; ?></span>
          </a></li>
          <li><a class="link-compare"  title="<?php echo $button_compare; ?>" onclick="tm_qv_compare.add('<?php echo $product_id; ?>');">
