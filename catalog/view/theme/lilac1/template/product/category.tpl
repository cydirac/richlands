...
<div class="main container">
  <div class="row">
    ...
    <div id="content" class="<?php echo $class; ?>">
      ...
      <div class="page-title"><h2 class="page-heading"> <span class="page-heading-title"><?php echo $heading_title; ?></span> </h2></div>
      ...
      <p class="cat-empty"><?php echo $text_empty; ?></p>
      <div class="buttons cat-btn-empty">
