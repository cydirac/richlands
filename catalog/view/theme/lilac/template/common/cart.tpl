<div id="cart">
  <div data-hover="dropdown" class="basket dropdown-toggle"> <a href="<?php echo $cart ?>"><span class="price hidden-xs"><?php echo $cart_heading; ?> </span><span class="cart_count hidden-xs"><?php echo $text_count; ?> <?php echo $text_item; ?> / <?php echo $text_total; ?></span></a> </div>  
  <input id="cart-txt-heading" type="hidden" name="cart-txt-heading" value="<?php echo $text_item; ?> ">
