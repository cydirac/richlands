...
<div class="main-container col1-layout wow bounceInUp animated">
  ...
  <div class="row">  
    <div id="content" class="col-sm-12">           
     <div class="page-title"><h2><?php if($testimonial_title){ echo $testimonial_title;}?></h2></div>
...
$('#review').load('index.php?route=thmtestimonial/thmtestimonial/testimonial');

$('#button-review').on('click', function() {
  $.ajax({
    url: 'index.php?route=thmtestimonial/thmtestimonial/write',
    type: 'post',
    dataType: 'json',
...
$('button[id^=\'button-upload\']').on('click', function() {
  ...
  timer = setInterval(function() {
    if ($('#form-upload input[name=\'file\']').val() != '') {
      ...
      $.ajax({
        url: 'index.php?route=thmtestimonial/thmtestimonial/imageupload',
        type: 'post',
        dataType: 'json',
