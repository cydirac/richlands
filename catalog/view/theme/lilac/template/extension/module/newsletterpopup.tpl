...
<div class="popup1 modal fade" id="myModal" tabindex="-1" role="dialog">
  ...
  <div class="newsletter-sign-box" style="background:#f8f8f8 url(<?php echo $newsletterpopup_bg_image; ?>) repeat scroll 100% 0px">
  <?php } else { ?>
  <div class="newsletter-sign-box">
  <?php } ?>
    <div class="newsletter"> 
       <button type="button" class="x" data-dismiss="modal" aria-label="Close"><img src="catalog/view/theme/<?php echo $thm_theme ?>/image/f-box-close-icon.png" alt="close" class="x" id="x"></button>
      ...
      <div class="email-form">        
        ...
        <?php if(isset($newsletterpopup_description)) echo $newsletterpopup_description;?>
        ...
        <div class="newsletter-form">
          <div class="input-box">
            ...
            <img src="catalog/view/theme/<?php echo $thm_theme ?>/image/loading.gif" alt="Loading" id="loader1" style="display:none;margin-left:120px;margin-top:10px;"> </div>
          <!--input-box--> 
        </div>
        <!--newsletter-form-->
...
$(document).ready(function(){
    if (localStorage.getItem("disp_tmnewsletter") === null || localStorage.getItem("disp_tmnewsletter")=='show') {
        $('#myModal').modal('show');
            $('#notshowpopup').click(function(){
                if($("#notshowpopup").is(':checked')){
                localStorage.setItem('disp_tmnewsletter', 'hide');
                }
                else
                {
                 localStorage.setItem('disp_tmnewsletter', 'show');
                }
