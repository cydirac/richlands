      ...
      <div class="product-essential">     
            ...
            <div class="product-image">
                <div class="product-full"> 
                    <?php if($thmlilac_sale_label==1) { 
                        if ($price && $special) { ?>
                       <div class="new-label new-top-left"><?php echo $thmlilac_sale_labeltitle; ?></div>
                    <?php } }  ?>
                    <img id="product-zoom" src="<?php echo $popup; ?>" data-zoom-image="<?php echo $popup; ?>"/> </div>
                    <?php if ($images || $thumb) { ?>
          ...
          <div class="product-shop col-lg-8 col-sm-7 col-xs-12">
            ...
            <div class="email-addto-box">
              ...
              <li><a class="link-wishlist" title="<?php echo $text_wishlist; ?>" onclick="tm_wishlist.add('<?php echo $product_id; ?>');">
              <span><?php echo $text_wishlist; ?></span>
              </a></li>
              <li><a class="link-compare"  title="<?php echo $button_compare; ?>" onclick="tm_compare.add('<?php echo $product_id; ?>');">
                     ...
                     <div class="item-img">
                      ...
                      <div class="box-hover">
                          <ul class="add-to-links">
                            ...
                            <li>
                              <a onclick="tm_wishlist.add('<?php echo $product['product_id']; ?>');" class="link-wishlist"><?php //echo $text_wishlist; ?></a> 
                            </li>
                            <li>
                                <a class="link-compare"  onclick="tm_compare.add('<?php echo $product['product_id']; ?>');"><?php //echo $text_compare; ?></a>
                            </li>
                         ...
                         <div class="info-inner">
                            ...
                            <div class="item-content">
                              ...
                              <div class="action"> 
                                  ...
                                  <button type="button" title="" data-original-title="<?php echo $button_cart; ?>" class="button btn-cart link-cart" onclick="tm_cart.add('<?php echo $product['product_id']; ?>');"><span><?php echo $button_cart; ?></span></button>
