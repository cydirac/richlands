<?php
class lilac_ControllerProductProduct extends ControllerProductProduct {
...
public function preRender( $template_buffer, $template_name, &$data ) {
      ...
      return parent::preRender( $template_buffer, $template_name, $data );
        ...
        $data['thmlilac_productpage_related_cb']=$this->config->get('thmlilac_productpage_related_cb');
        $data['thmlilac_productpage_related_cbcontent']=$this->config->get('thmlilac_productpage_related_cbcontent');
...
public function info()
    {
        ...
        $this->response->setOutput($this->load->view('product/thmrelated_list', $data));
